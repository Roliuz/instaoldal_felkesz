...
$edzeselotti->execute();
$edzeselottik = $edzeselotti->fetchAll(PDO::FETCH_ASSOC);

$termekek_szama = $pdo->query("SELECT * FROM termekek WHERE termek_tipus = 'edzeselotti'")->rowCount();
?>
<div class="container">
    ...
    <div class="row m-3">
        ...
        <div class="col-9">
            <div class="row">
                ...
                if ($termekek_szama >= 1) :
                ?>
                    <?php foreach ($edzeselottik as $edzes) : ?> <!-- foreach segítségével addig fut le amíg talál termékeket (szóval jelen esetben 4-szer) -->
                        <div class="col-lg-4 col-md-5 mt-3  ">
                            ...
                            <a href="index.php?oldal=termek&id=<?= $edzes['id'] ?>"> <!-- adatbázisból meghívom a termékek nevét, leírás, árát, képét, stb.. -->
                                <div class="card h-100 border-0 " style="width: 15rem; ">
                                    <img src="../../Pic/<?= $edzes['img'] ?>" class="card-img-top" alt="<?= $edzes['nev'] ?>">
